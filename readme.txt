...
chính xác hiện tại của mô hình khá là thấp, chỉ đạt khoảng 53,5%.
...
Classes: 196
Optimizer: Adam Optimization Algorithm
The model can classify 196 types of cars, but the current accuracy of the model is quite low, only about 53.5%. 
